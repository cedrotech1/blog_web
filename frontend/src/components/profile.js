...
const LandingPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_BASE_URL}/users/update/1`, {
                method: 'PUT',
                headers: {
    ...
    const handleSubmitProfile = async (e) => {
        ...
        try {
            ...
            formDataUpload.append('profile', formDataImage.image);
            ...
            if (response.ok) {
                ...
                const updatedUser = { ...selectedUser, profile: res.user.profile };
                localStorage.setItem('user', JSON.stringify(updatedUser));
                                ...
                                <div className="info-itemx d-flex">
                                    <div>
                                        {formData.profile && formData.profile !== 'null' ? (
                                            <img src={formData.profile} className="img-fluid" alt="" style={{ borderRadius: '10px', marginBottom: '0.5cm', width: '11cm' }} onClick={handleToggleFileUploadModal} />
                        ...
                        <div className="col-lg-8">
                            <form onSubmit={handleSubmit} className="myform">
                                ...
                                <div className="row" style={{ paddingTop: '0.3cm' }}>
                                    ...
                                    <div className="col-md-6 form-group mt-3 mt-md-0">
                                        <span>SLOGAN</span>
                                        <input type="text" className="form-control" name="slog" id="address" value={formData.slog} onChange={handleChange} />
                                    </div>

                                    <div className="col-md-6 form-group mt-3 mt-md-0">
                                        <span>About</span>
                                        <input type="text" className="form-control" name="about" id="address" value={formData.about} onChange={handleChange} />
                                    </div>
                                </div>
